...
import 'package:Kaviet/pages/history/detail_history_screen.dart';
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          '${DateFormat("HH:mm").format(DateTime.fromMillisecondsSinceEpoch((historyData.pay_date) * 1000))}',
                                          textAlign: TextAlign.left,
                                          style: TextStyle(
                                            fontWeight: FontWeight.w600,
                                            fontSize: 22,
