...
import 'package:Kaviet/pages/cash-box/history_list_cash_view.dart';
import 'package:Kaviet/pages/cash-box/model/history_list_cash_data.dart';
...
class HistoryCashScreen extends StatefulWidget {
  @override
  _HistoryCashScreenState createState() => _HistoryCashScreenState();
}

class _HistoryCashScreenState extends State<HistoryCashScreen>
    with TickerProviderStateMixin {
  AnimationController animationController;
  List<HistoryCashListData> historyList = HistoryCashListData.historyList;
        ...
        builder: (BuildContext context, AsyncSnapshot<Map> snapshot) {
          ...
          if (snapshot.hasData) {
            ...
            data.forEach((element) {
              historyList.add(HistoryCashListData(
                  pay_date: int.parse(element['created_at'].toString()),
                  total_price:
                      double.parse(element['money_expected'].toString()),
              ...
              result = Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return HistoryCashListView(
                      callback: () {},
                      historyList: historyList[index],
                      animation: animation,
                      animationController: animationController,
                    );
                  },
